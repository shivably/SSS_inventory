...
urlpatterns = [
    ...
    re_path(r'delete/(?P<pk>\d+)/$',
            EmployeeDelete.as_view(), name='delete_employee'),
    re_path(r'salary/(?P<pk>\d+)/$',
            EmployeeSalaryView.as_view(), name='employee_salary'),
    re_path(r'salary/(?P<pk>\d+)/detail/$',
            EmployeeSalaryDetail.as_view(), name='employee_salary_detail'),
]
