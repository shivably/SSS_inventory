...
class Ledger(DatedModel):
    retailer = models.ForeignKey(
        'retailer.Retailer', related_name='retailer_ledger', blank=True, null=True, on_delete=models.CASCADE)
    customer = models.ForeignKey(
        'com.Customer', related_name='customer_ledger', on_delete=models.CASCADE
    )
    invoice = models.ForeignKey(
        'sales.SalesHistory', related_name='ledger_invoice',
