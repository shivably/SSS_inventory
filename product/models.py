...
from com.models import DatedModel
...
class PurchasedProduct(DatedModel):
    ...
    invoice = models.ForeignKey(
        'sales.SalesHistory', related_name='purchased_invoice',
...
class ExtraItems(DatedModel):
    retailer = models.ForeignKey(
        'retailer.Retailer', related_name='retailer_extra_items', on_delete=models.CASCADE
    )
...
class ClaimedProduct(DatedModel):
    ...
    customer = models.ForeignKey(
        'com.Customer', related_name='customer_claimed_items',
...
class StockOut(models.Model):
    ...
    invoice = models.ForeignKey(
        'sales.SalesHistory', related_name='out_invoice',
        blank=True, null=True, on_delete=models.CASCADE
    )
...
def purchase_product(sender, instance, created, **kwargs):
    """
    TODO: Please check this function is useful or not.
    :param sender:
    :param instance:
    :param created:
    :param kwargs:
