...
from product.forms import PurchasedProductForm
from sales.forms import BillingForm
from product.forms import ExtraItemForm, StockOutForm
from com.forms import CustomerForm
from ledger.models import Ledger
from ledger.forms import LedgerForm
from django.db import transaction
from product.models import PurchasedProduct, StockOut
from com.models import Customer
            ...
            for item in items:
                ...
                if item.get('item_id'):
                    ...
                    if not purchased_item.quantity == item.get('qty'):
                        ...
                        purchased_item.discount_percentage = item.get(
                            'perdiscount')
