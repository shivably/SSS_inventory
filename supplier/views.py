...
from supplier.forms import SupplierForm, SupplierStatementForm
...
class SupplierList(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        try:
            supplier_amounts = supplier_statements.aggregate(
                Sum('supplier_amount'))
            supplier_amounts = supplier_amounts.get(
                'supplier_amount__sum') or 0
            payment_amounts = supplier_statements.aggregate(
                Sum('payment_amount'))
...
class SupplierStatementList(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        supplier_statements = SupplierStatement.objects.filter(
...
class SupplierStatementUpdate(UpdateView):
    ...
    def form_valid(self, form):
        ...
        return HttpResponseRedirect(
            reverse('supplier:list_supplier_statement',
    ...
    def get_context_data(self, **kwargs):
        context = super(SupplierStatementUpdate,
